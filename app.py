...
class ConnectionManager(object):    
    ...
    def __getConnection(self):
        if (self.__connection == None):
            ...
            # "DRIVER={ODBC Driver 17 for SQL Server};SERVER=notejamdbserver.database.windows.net;DATABASE=WideWorldImporters;UID=PythonWebApp;PWD=a987REALLY#$%TRONGpa44w0rd"
            # $Env:FLASK_ENV="development"
            # $Env:SQLAZURECONNSTR_WWIF="DRIVER={ODBC Driver 17 for SQL Server};
            # SERVER=notejamdbserver.database.windows.net;
            # DATABASE=WideWorldImporters;
            # UID=notejam;
            # PWD=Python123$;"
            # DSN=mynewdsn;UID=user;PWD=password

            self.__connection = pyodbc.connect(os.environ['SQLAZURECONNSTR_WWIF'] )   
